...
<div class="card">
    <!-- Botón NUEVO CLIENTE -->
    <button type="button" id="btnNuevoCliente" class="btn btn-outline-secondary"
            ...
            <form id="form_clientes" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="email" name="correo_electronico" id="correo_electronico" class="form-control" placeholder="ejemplo@correo.com">
                    </div>
                </div>
